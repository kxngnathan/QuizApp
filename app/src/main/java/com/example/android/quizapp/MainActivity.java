...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean checkQuestion2() {
        CheckBox checkBox = (CheckBox) findViewById(R.id.disk);
        CheckBox checkBox1 = (CheckBox) findViewById(R.id.drive);
    ...
    private boolean editQuestion3() {
        ...
        return editText.getText().toString().equalsIgnoreCase("Internet Service Provider");
    }
    // question 4
    private boolean editQuestion4() {
        ...
        return editText.getText().toString().equalsIgnoreCase("World Wide Web");
    }
    // question 5
    ...
    public void reset(View view) {
        ...
        CheckBox checkBox = findViewById(R.id.disk);
        checkBox.setChecked(false);
        checkBox = findViewById(R.id.drive);
        checkBox.setChecked(false);
        checkBox = findViewById(R.id.keyboard);
        checkBox.setChecked(false);
        checkBox = findViewById(R.id.mouse);
        checkBox.setChecked(false);
